!function() {
    ...
    ace.settings = {
        saveState: function(a, b, c, d) {
            ...
            j ? delete f[b] : k.test(b) ? (f.hasOwnProperty(b) || (f[b] = {}),
            d === !0 ? f[b][h] = 1 : d === !1 ? f[b][h] = -1 : f[b].className = h) : f[b] = h,
    ...
    function() {
        var a = function() {
            ...
            if (void 0 !== f.style.animationName && (a = !0),
            a === !1)
    ...
    ace.data_storage = function(a, b) {
        var c = "ace_"
          , d = null
          , e = 0;
        (1 == a || a === b || 0 == a) && "localStorage"in window && null !== window.localStorage ? (d = ace.storage,
        e = 1) : null == d && (2 == a || a === b) && "cookie"in document && null !== document.cookie && (d = ace.cookie,
        e = 2),
        this.set = function(a, b, f, g, h, i) {
            if (d)
                if (f === i)
                    ...
                    null == f ? d.remove(c + a + "_" + b) : (h && "object" == typeof f && (f = JSON.stringify(f)),
                    d.set(c + a + "_" + b, f));
                else if (2 == e) {
                    var j = d.get(c + a)
                      , k = j ? JSON.parse(j) : {};
        ...
        this.remove = function(a, b, c) {
            d && (b === c ? (b = a,
            this.set(b, null)) : this.set(a, b, null))
        }
    }
    ,
    ace.cookie = {
