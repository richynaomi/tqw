    ...
    var c = function(b, c) {
        ...
        this.create = function(b) {
            if (!x) {
                ...
                "static" == this.$element.css("position") ? (P = this.element.style.position,
                this.element.style.position = "relative") : P = !1;
                var c = null;
                U ? c = a('<div class="scroll-track scroll-detached"><div class="scroll-bar"></div></div>').appendTo("body") : (this.$element.wrapInner('<div class="scroll-content" />'),
                ...
                z = y.get(0),
                U ? (A = c,
                k()) : A = this.$element.find(".scroll-track").eq(0),
                B = A.find(".scroll-bar").eq(0),
                C = A.get(0),
                D = B.get(0),
                E = D.style,
                u || A.addClass("scroll-hz"),
                n.styleClass && (L = n.styleClass,
                A.addClass(L),
                M = !!L.match(/scroll\-left|scroll\-top/)),
                0 == N && (A.show(),
                j()),
                A.hide(),
                A.on("mousedown", d),
                ...
                y.on("scroll", function() {
                    J && (G = parseInt(Math.round(this[s] * O)),
                    E[o] = G + "px"),
                    J = !1,
                    T && this.$element.trigger("scroll", [z])
                }),
                n.mouseWheel && (this.lock = n.mouseWheelLock,
                ...
                if (f) {
                    ...
                    this.$element.on(m + ".ace_scroll", function(a) {
                        ...
                        if (g = a.direction,
                        u && ("up" == g || "down" == g) || !u && ("left" == g || "right" == g)) {
                            var b = u ? a.dy : a.dx;
                            0 != b && (Math.abs(b) > 20 && f && (b = 2 * b),
                            l.move_bar(!0),
                            z[s] = z[s] + b)
                        }
                    })
        ...
        this.destroy = function() {
            ...
            U || (u || y.find("> div").children().unwrap(),
            y.children().unwrap(),
            y.remove()),
            A.remove(),
        ...
        this.update = function(b) {
            ...
            S = n.dragEvent || !1,
            "undefined" != typeof b.styleClass && (L && A.removeClass(L),
            L = b.styleClass,
            L && A.addClass(L),
            M = !!L.match(/scroll\-left|scroll\-top/))
        }
...
function(a, b) {
    var c = function(b, c) {
        ...
        f.addClass("hide").find("option").each(function() {
            ...
            b.indexOf("number") >= 0 || (this.value != b && (this.value = b),
            this.selected && (a += " selected",
            h = b),
            j.push(b),
            g += '<li><a class="' + a + '" style="background-color:' + b + ';" data-color="' + b + '"></a></li>')
        ...
        this.pick = function(c, d) {
            if ("number" == typeof c) {
                ...
                if (c = j.indexOf(e),
                -1 == c && d === !0 && (j.push(e),
                a("<option />").appendTo(f).val(e),
                a('<li><a class="colorpick-btn"></a></li>').appendTo(k).find("a").css("background-color", e).data("color", e),
                c = j.length - 1),
                -1 == c)
                    return;
                k.find("a:eq(" + c + ")").trigger(ace.click_event, [!0])
...
function(a, b) {
    ...
    g.prototype.apply_settings = function() {
        ...
        this.well_style ? (this.settings.thumbnail || (this.settings.thumbnail = "small"),
        this.$element.parent().addClass("ace-file-multiple")) : this.$element.parent().removeClass("ace-file-multiple"),
        ...
        if (e) {
            ...
            f.on(ace.click_event, function(a) {
                ...
                !b.can_reset)
                    return !1;
                var c = !0;
                if (b.settings.before_remove && (c = b.settings.before_remove.call(b.element)),
                !c)
                    return !1;
                b.reset_input();
                return !1
    ...
    g.prototype.loading = function(b) {
        if (b === !1)
            ...
            0 == d.length && (d = a('<div class="ace-file-overlay"></div>').appendTo(this.$container),
    ...
    var h = function() {
        ...
        b.off("dragenter").on("dragenter", function(a) {
            ...
            !a.disabled) {
                ...
                d === !1 ? !1 : (a.$element.data("ace_input_method", "drop"),
                a.$element.data("ace_input_files", d),
                a.show_file_list(d, !0),
                a.$element.triggerHandler("change", [!0]),
                !0)
            }
        })
    }
      , i = function() {
        ...
        a === !1 ? !1 : (this.$element.data("ace_input_method", "select"),
        this.$element.data("ace_input_files", a),
        this.show_file_list(a, !0),
        !0)
    }
      , j = function(b) {
        var c = this
          ...
          , i = function(b, f) {
            ...
            "large" == c.settings.thumbnail && (h = 150))),
      ...
      , k = function(b, c, d) {
        ...
        var g = !1
          , h = !1
          , i = !1;
        "number" == typeof c ? g = c : c instanceof Object && (c.previewWidth && !c.previewHeight ? i = c.previewWidth : c.previewHeight && !c.previewWidth ? h = c.previewHeight : c.previewWidth && c.previewHeight && (i = c.previewWidth,
        h = c.previewHeight)),
        g ? e > f ? (i = g,
        h = parseInt(f / e * i)) : (h = g,
        i = parseInt(e / f * h)) : !h && i ? h = parseInt(f / e * i) : h && !i && (i = parseInt(e / f * h));
        var j;
        try {
        ...
        return j ? (/^data\:image\/(png|jpe?g|gif);base64,[0-9A-Za-z\+\/\=]+$/.test(j) || (j = null),
        j ? {
            src: j,
            previewWidth: i,
            previewHeight: h,
      ...
      , l = function(a, b) {
        ...
        return -1 === c ? (this.reset_input(),
        !1) : c && 0 != c.length ? ((c instanceof Array || d && c instanceof FileList) && (a = c),
        c = !0,
        this.settings.before_change && (c = this.settings.before_change.call(this.element, a, b)),
        -1 === c ? (this.reset_input(),
        !1) : c && 0 != c.length ? ((c instanceof Array || d && c instanceof FileList) && (a = c),
        a) : (this.$element.data("ace_input_files") || this.reset_input(),
        !1)) : (this.$element.data("ace_input_files") || this.reset_input(),
        !1)
    }
      , m = function(a) {
        return a ? ("string" == typeof a && (a = [a]),
        0 == a.length ? null : new RegExp(".(?:" + a.join("|") + ")$","i")) : null
    }
      , n = function(a) {
        return a ? ("string" == typeof a && (a = [a]),
        0 == a.length ? null : new RegExp("^(?:" + a.join("|").replace(/\//g, "\\/") + ")$","i")) : null
    }
      , o = function(b, c) {
            ...
            if (!d || d.test(p))
                if (e && e.test(p))
                    ...
                    if (f) {
                        ...
                        i && o.size > i ? ("size"in k || (k.size = []),
                        k.size.push(p)) : j.push(o)
                    } else
                        j.push(o)
                }
            else
    ...
    a.fn.ace_wysiwyg = function(b, c) {
        ...
        return this.each(function() {
            ...
            b.find(".dropdown-menu input[type=text]").on("click", function() {
                ...
                27 == b.which ? (this.value = "",
                a(this).change()) : 13 == b.which && (b.preventDefault(),
                b.stopPropagation(),
                a(this).change())
            }),
...
function(a, b) {
    function c(b, c) {
        ...
        var g = parseInt(Math.max(20 * f + 40, 90))
          ...
          , i = "btn-sm"
          , j = 2;
        h.hasClass("input-sm") ? (i = "btn-xs",
        j = 1) : h.hasClass("input-lg") && (i = "btn-lg",
        j = 3),
        2 == j ? g += 25 : 3 == j && (g += 50),
        ...
        var k = h.closest(".ace-spinner").spinbox(e).wrapInner("<div class='input-group'></div>")
          , l = k.data("fu.spinbox");
        e.on_sides ? (h.before('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-down ' + i + " " + e.btn_down_class + '">						<i class="icon-only ' + ace.vars.icon + e.icon_down + '"></i>					</button>				</div>').after('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-up ' + i + " " + e.btn_up_class + '">						<i class="icon-only ' + ace.vars.icon + e.icon_up + '"></i>					</button>				</div>'),
        k.addClass("touch-spinner"),
        k.css("width", g + "px")) : (h.after('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-up ' + i + " " + e.btn_up_class + '">						<i class="icon-only ' + ace.vars.icon + e.icon_up + '"></i>					</button>					<button type="button" class="btn spinbox-down ' + i + " " + e.btn_down_class + '">						<i class="icon-only ' + ace.vars.icon + e.icon_down + '"></i>					</button>				</div>'),
        ace.vars.touch || e.touch_spinner ? (k.addClass("touch-spinner"),
        k.css("width", g + "px")) : (h.next().addClass("btn-group-vertical"),
        k.css("width", g + "px"))),
    ...
    a.fn.ace_spinner = function(d, e) {
        var f, g = this.each(function() {
            var b = a(this)
              ...
              , h = "object" == typeof d && d;
            g || (h = a.extend({}, a.fn.ace_spinner.defaults, d),
            b.data("ace_spinner", g = new c(this,h))),
...
function(a, b) {
    function c(b, c) {
        ...
        if (this.settings = a.extend({}, a.fn.ace_aside.defaults, c, j),
        ...
        this.container && (this.settings.backdrop = !1,
        f.addClass("aside-contained"));
        ...
        this.initiate = function() {
            ...
            f.addClass("aside-" + g),
            /right|left/.test(g) ? (h = !0,
            f.addClass("aside-vc")) : f.addClass("aside-hz"),
            ...
            this.settings.body_scroll || f.on("mousewheel.aside DOMMouseScroll.aside touchmove.aside pointermove.aside", function(b) {
                return a.contains(m[0], b.target) ? void 0 : (b.preventDefault(),
                !1)
            }),
        ...
        ,
        this.hide = function() {
            this.container && (this.container.addClass("overflow-hidden"),
            ace.vars.firefox && b.offsetHeight),
            o(),
        ...
        this.shown = function() {
            if (o(),
            a("body").removeClass("modal-open").css("padding-right", ""),
            "invisible" == this.settings.backdrop)
                try {
        ...
        this.hidden = function() {
            d.off(".aside"),
            ace.vars.transition && !i || (f.addClass("aside-hidden"),
            f.css("position", ""))
        }
        ,
        this.insideContainer = function() {
            ...
            b.hasClass("container")) {
                var e = !1;
                1 == h && (c.css(g, parseInt((d.width() - b.width()) / 2)),
                e = !0),
